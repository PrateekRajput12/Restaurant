...
const WhatsAppFloatingButton: React.FC = () => {
  const handleWhatsAppClick = () => {
    const phoneNumber = '1234567890'; // Replace with actual restaurant number
    const message = encodeURIComponent("Hello L'Art Culinaire! I would like to inquire about a reservation or view the special menu for today.");
